...
const StationDetails = (props) => {
    ...
    const stationTimestamp = props.stationTimestamp
    const stationName = stationData.name
    const city = stationData.city
    const state = stationData.state.name
    const country = stationData.country.name
    const dawn = stationTimestamp.sunrise_sunset.local.civil_dawn
    const rise = stationTimestamp.sunrise_sunset.local.sun_rise
    const set = stationTimestamp.sunrise_sunset.local.sun_set
    const dusk = stationTimestamp.sunrise_sunset.local.civil_dusk
